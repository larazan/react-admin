...
import { updateSection } from '../../../actions/products_actions';
...
class UpdateSection extends Component {
    ...
    onUpdateHandler = e => {
        ...
        this.props.dispatch(updateSection(this.state, existingProps)).then(response=>{
...
export default connect(mapStoreToProps)(withRouter(UpdateSection));