...
class Category extends Component {
    ...
    componentDidMount() {
        this.props.dispatch(getCategories()).then(response => {
            this.setState({
                records: this.props.products.category
            })
        })
    };
    ...
    deleteRecord(record) {
        // axios
        //     .post("/api/product/category-delete", {_id: record._id})
        //     .then(res => {
        //         if (res.status === 200) {
    ...
    render() {
        ...
        return (
            <>
                <AddCategory />    
                <UpdateCategory record={this.state.currentRecord} />
                <DeleteCategory record={this.state.currentRecord} />
