...
import { updateCategory } from '../../../actions/products_actions';
...
class UpdateCategory extends Component {
    ...
    onUpdateHandler = e => {
        ...
        this.props.dispatch(updateCategory(this.state, existingProps)).then(response=>{
...
export default connect(mapStoreToProps)(withRouter(UpdateCategory));