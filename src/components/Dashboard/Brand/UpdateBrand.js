...
import { updateBrand } from '../../../actions/products_actions';
...
class UpdateBrand extends Component {
    ...
    onUpdateHandler = e => {
        ...
        this.props.dispatch(updateBrand(this.state, existingProps)).then(response=>{
...
export default connect(mapStoreToProps)(withRouter(UpdateBrand));